...
export class UsageStatsRecorder {
  private currentUsageFilePath: any;

  private processUsageStatsTimmer: any;
  ...
  private async createCurrentUsageFile(fsPath: string, document: any) {
  ...
  private async onDidChangeActiveTextEditor(textEditor: any) {
